/**
 * Sync root shared theme/icons into player/public.
 *
 * Player runtime (player.js / player.css / vendor) lives in public/ directly.
 * This script only keeps design-system assets shared with the extension
 * (`shared/theme*`, brand icons, Phosphor font) up to date.
 *
...
const SHARED_ICON_FILES = ["icon.svg", "icon32.png", "phosphor-icons.css", "Phosphor.woff2"];
